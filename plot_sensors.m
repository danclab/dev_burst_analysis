...
function [handle,Zi,grid,Xi,Yi] = plot_sensors(Values,loc_file,varargin)
  ...
  if isempty(EMARKER2CHANS)
      for i=1:length(x)
        hp2 = plot3(y(i),x(i),ELECTRODE_HEIGHT,...
            EMARKER,'MarkerFaceColor',ECOLOR(i,:),'Color',ECOLOR(i,:),'markersize',5,'linewidth',EMARKERLINEWIDTH);
      end
